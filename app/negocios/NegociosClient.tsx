...
import type { Negocio, PipelineEstado, Rol, Contacto, UsuarioCRM } from '@/lib/types'
...
// Combobox de búsqueda de contactos — reutiliza /api/leads (mismo endpoint que
// alimenta la vista de Leads) en vez de duplicar lógica de búsqueda.
function ContactoSearch({ value, onSelect }: {
  value: string
